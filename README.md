...
unzip alpine.zip
```
You should end up with alpine.{sh, ext4, conf}, also when Alpine is running it will log in here into "alpine.log". You can also delete alpine.zip now.
